...
namespace OnlineEdu.API.Controllers
{
    ...
    [ApiController]
    public class BlogsCategoryController(IGenericServis<BlogCategory>_blogCategoryService,IMapper _mapper) : ControllerBase
    {
        [HttpGet]
        ...
        public IActionResult DeleteById(int id)
        {
            ...
            return Ok("Blog Categori Alanı Silindi");
        }
        [HttpPost]
        ...
        public IActionResult Update(UpdateBlogCategoryDto updateBlogCategoryDto)
        {
            ...
            return Ok("Blog Category alanı düzeltildi");
        }
    }
}
